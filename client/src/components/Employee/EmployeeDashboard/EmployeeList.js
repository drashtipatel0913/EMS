...
export default class EmployeeTable extends Component {
  ...
  handleFilterByStatus = (status) => {
    filterByCurrentStatus(status, this.fetchEmployees, this.setState.bind(this));
  };

  handleFilterByUpcoming = (upcoming) => {
    filterByUpcoming(upcoming, this.fetchEmployees, this.setState.bind(this));
  };
  ...
  render() {
    const { employees, message } = this.state;
