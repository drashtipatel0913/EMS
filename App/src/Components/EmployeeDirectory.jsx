  ...
  return (
    <React.Fragment>
      ...
      <Container className="mt-3">
        <h3 className="text-center">Welcome to the Employee Management System</h3>

        <Card className="my-3">
          <Card.Body>
            <Card.Title>Employee Operations</Card.Title>
            <Card.Text>
              Manage employees with features like creating, updating, viewing, and deleting employee records.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="mt-3">
          <Card.Body>
            ...
            <Card.Text>
              To get started, click on the navigation links to access different features:
              <ul>
                <li>Create Employee - Add a new employee to the system.</li>
                <li>View Employees - Explore the list of existing employees.</li>
            ...
            <Button variant="outline-primary" as={NavLink} to="/create-employee" className="me-3 text-dark">
              Create Employee
            </Button>
            <Button variant="outline-info" as={NavLink} to="/view-employee" className="text-dark">
              View Employees
            </Button>
          </Card.Body>
        </Card>
